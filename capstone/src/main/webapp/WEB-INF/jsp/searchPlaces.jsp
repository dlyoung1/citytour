...
h5.clickToAdd {
	...
	text-decoration-color: rgb(255, 209, 0);
}
...
<button type="button" class="viewItinerary btn btn-warning nav-item"
	data-toggle="modal" data-target="#generateItinerary">View
	Itinerary</button>
...
<div class="container">
	...
	<div class="row">
		...
		<div class="categoriesCard" style="float: left;">
			...
			<form name="frm_map" id="frm_map">
				<div class="col">
					<div class="card text-center" style="width: 250px; height: 500px"
						id="categories">
						<div class="card-body">
	...
	<div
		style="float: left; background-color: rgb(25, 25, 25); color: white; opacity: 0.8; margin-bottom: 30px">
...
<script>
	...
	function callback(results, status) {
		...
		if (status == google.maps.places.PlacesServiceStatus.OK) {
			var html = '<h4>Landmark details:</h4><h5 class="clickToAdd">(Click to add to itinerary)</h5><ul';
		...
		var html = '<h4>Your Current Itinerary: </h4><ul>';
		$('#placeList li')
				.click(
						function() {
							var selectedPlace = this.dataset.value;
							html += '<li id="' + selectedPlace + '">'
									+ selectedPlace + '</li>';
